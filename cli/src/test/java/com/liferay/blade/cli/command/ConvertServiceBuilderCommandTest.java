...
public class ConvertServiceBuilderCommandTest {
	...
	@Test
	public void testConvertServiceBuilderWithRemoveTrue() throws Exception {
		File testdir = new File(temporaryFolder.getRoot(), "build/testMigrateServiceBuilder");
		...
		args = new String[] {"--base", projectDir.getPath(), "convert", SB_PROJECT_NAME, "-r", Boolean.TRUE.toString()};
